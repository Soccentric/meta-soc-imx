...
Yocto meta-layer for NXP i.MX - Yocto scarthgap

## Overview

This layer provides custom images, kernel, bootloader, and device tree support for NXP i.MX platforms.
...
# Clone this layer
git clone <YOUR_REPO_URL> meta-soc-imx
...
BBLAYERS ?= " \
  ...
  /path/to/meta-freescale \
  /path/to/meta-soc-imx \
"
```
...
bitbake imx-image-ros2
bitbake imx-image-iot
bitbake imx-image-grpc
bitbake imx-image-vision
bitbake imx-image-dds
bitbake imx-image-rust
```
...
```
SRC_URI = "git://github.com/YOUR-ORG/linux-imx.git;protocol=https;branch=main"
...
```
SRC_URI = "git://github.com/YOUR-ORG/u-boot-imx.git;protocol=https;branch=main"
...
2. Build: `bitbake rpu-firmware-imx`
...
### Vision System Image: imx-image-vision
...
1. Flash image to SD card/eMMC:
   ```bash
   sudo dd if=tmp/deploy/images/imx8mpevk/<image>.wic \
...
- **NXP i.MX BSP**: [Add BSP documentation URL]
